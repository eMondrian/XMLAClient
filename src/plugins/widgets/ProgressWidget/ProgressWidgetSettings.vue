...
import type { GradientPart, IProgressSettings } from "@/types/Widgets";
...
<template>
    <va-collapse v-model="opened.widgetSection" :header="t('ProgressWidget.title')">
        <div class="settings-container">
            <va-input v-model="widgetSettings.progress" :label="t('ProgressWidget.progress')" />
            <va-color-input v-model="widgetSettings.fillColor" :label="t('ProgressWidget.fillColor')" />
            <va-color-input v-model="widgetSettings.backgroundColor" :label="t('ProgressWidget.backgroundColor')" />
            <va-checkbox v-model="widgetSettings.isVertical" :label="t('ProgressWidget.isVertical')" />
            <va-checkbox v-model="widgetSettings.isGradient" :label="t('ProgressWidget.isGradient')" />
        </div>
        <div class="mt-3" v-if="widgetSettings.isGradient">
            ...
            <div>
                <va-input class="mt-2" v-model="widgetSettings.rotation" :label="t('ProgressWidget.rotation')" />
                <va-data-table class="table-config" :items="gradientFields" :columns="[
                    { key: 'color' },
                    { key: 'location' },
                    { key: 'actions' },
                ]">
