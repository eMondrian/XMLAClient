...
<template>
    <va-collapse v-model="opened.widgetSection" :header="t('RepeatableSvgWidget.title')">
        <div class="settings-container">
            ...
            <div class="colors">
                <va-color-input class="color-input" v-model="widgetSettings.activeItemStyles.fill"
                    :label="t('RepeatableSvgWidget.activeItemFill')" />
                <va-color-input class="color-input" v-model="widgetSettings.activeItemStyles.stroke"
                    :label="t('RepeatableSvgWidget.activeItemStroke')" />
            </div>
            <div class="colors">
                <va-color-input class="color-input" v-model="widgetSettings.defaultItemStyles.fill"
                    :label="t('RepeatableSvgWidget.defaultItemFill')" />
                <va-color-input class="color-input" v-model="widgetSettings.defaultItemStyles.stroke"
