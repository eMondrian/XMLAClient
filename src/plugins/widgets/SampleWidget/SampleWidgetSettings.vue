        ...
        <div class="settings-container">
            ...
            <div class="settings-block">
                ...
                <div class="align-buttons-group align-buttons-group__format">
                    ...
                    <VaButton color="#fafafa" class="align-button" icon="format_italic" size="small"
                        icon-color="#000000" v-model="widgetSettings.fontStyle" />
                    <VaButton color="#fafafa" class="align-button" icon="format_underline" size="small"
                        icon-color="#000000" v-model="widgetSettings.textDecoration" />
                </div>
            </div>
            <div class="settings-block">
                <div class="align-buttons-group">
                    ...
                    <div class="align-vertical-buttons ml-2">
                        <VaButton color="#fafafa" class="align-button" icon="align_vertical_top" size="small"
