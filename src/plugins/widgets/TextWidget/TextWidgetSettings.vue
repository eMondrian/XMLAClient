            ...
            <div class="settings-block">
                ...
                <div class="align-buttons-group align-buttons-group__format">
                    <VaButton
                        ...
                        size="small"
                        icon-color="#000000"
                        :color="widgetSettings.fontWeight === 'bold' ? '#5983d4' : '#fafafa'"
                        @click="widgetSettings.fontWeight === 'bold' ? widgetSettings.fontWeight = 'normal' : widgetSettings.fontWeight = 'bold'"
                    />
                    <VaButton
                        class="align-button"
                        icon="format_italic"
                        size="small"
                        icon-color="#000000"
                        :color="widgetSettings.fontStyle === 'italic' ? '#5983d4' : '#fafafa'"
                        @click="widgetSettings.fontStyle === 'italic' ? widgetSettings.fontStyle = 'normal' : widgetSettings.fontStyle = 'italic'"
                    />
                    <VaButton
                        class="align-button"
                        ...
                        size="small"
                        icon-color="#000000"
                        :color="widgetSettings.textDecoration === 'underline' ? '#5983d4' : '#fafafa'"
                        @click="widgetSettings.textDecoration === 'underline' ? widgetSettings.textDecoration = 'None' : widgetSettings.textDecoration = 'underline'"
                    />
                </div>
            </div>
            <div class="settings-block">
