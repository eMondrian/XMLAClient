...
import type { IRichTextEditorSettings } from "@/types/Widgets";
    ...
    <va-collapse v-model="opened.widgetSection" :header="t('RichTextWidget.title')">
        <div class="settings-container">
            <div v-if="editor">
                ...
                <va-button class="editor-btn" @click="editor.chain().focus().toggleItalic().run()" :disabled="!editor.can().chain().focus().toggleItalic().run()
                    " :class="{ 'is-active': editor.isActive('italic') }">
                    {{ t("RichTextWidget.italic") }}
                </va-button>
                <va-button class="editor-btn" @click="editor.chain().focus().toggleStrike().run()" :disabled="!editor.can().chain().focus().toggleStrike().run()
                    " :class="{ 'is-active': editor.isActive('strike') }">
                    {{ t("RichTextWidget.strike") }}
                </va-button>
                <va-button class="editor-btn" @click="editor.chain().focus().toggleUnderline().run()" :disabled="!editor.can().chain().focus().toggleUnderline().run()
                    " :class="{ 'is-active': editor.isActive('underline') }">
                    {{ t("RichTextWidget.underline") }}
                </va-button>
                <va-button class="editor-btn" @click="editor.chain().focus().toggleCode().run()"
                ...
                <va-button class="editor-btn" @click="editor.chain().focus().setParagraph().run()"
                    :class="{ 'is-active': editor.isActive('paragraph') }">
                    {{ t("RichTextWidget.paragraph") }}
                </va-button>
                <va-button class="editor-btn" @click="
            ...
            'is-active': editor.isActive('heading', { level: 3 })}">
                ...
                <va-button class="editor-btn" @click="editor.chain().focus().toggleBulletList().run()"
                    :class="{ 'is-active': editor.isActive('bulletList') }">
                    {{ t("RichTextWidget.bulletList") }}
                </va-button>
                <va-button class="editor-btn" @click="editor.chain().focus().toggleOrderedList().run()"
                    :class="{ 'is-active': editor.isActive('orderedList') }">
                    {{ t("RichTextWidget.orderedList") }}
                </va-button>
                <va-button class="editor-btn" @click="editor.chain().focus().toggleCodeBlock().run()"
                    :class="{ 'is-active': editor.isActive('codeBlock') }">
                    {{ t("RichTextWidget.codeBlock") }}
                </va-button>
                <va-button class="editor-btn" @click="editor.chain().focus().toggleBlockquote().run()"
                ...
                <va-button class="editor-btn" @click="editor.chain().focus().undo().run()"
                    :disabled="!editor.can().chain().focus().undo().run()">
                    {{ t("RichTextWidget.undo") }}
                </va-button>
                <va-button class="editor-btn" @click="editor.chain().focus().redo().run()"
