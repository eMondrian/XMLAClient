...
export function initMDXCompletionProvider(cubes: MDSchemaCube[], metadataStore) {
  monaco.languages.registerCompletionItemProvider('mdx', {
    provideCompletionItems: async (model, position) => {
      ...
      const dimensionsSuggestions = dimensions.map((dimension: MDSchemaDimension) => ({
      ...
      const hierarchySuggestions = hierarchies.map((hierarchy: MDSchemaHierarchy) => ({
      ...
      const functionSuggestions = [
        ...
        },
        {
          label: 'IIF',
          kind: monaco.languages.CompletionItemKind.Function,
          insertText: 'IIF(${1:condition}, ${2:value_if_true}, ${3:value_if_false})',
          insertTextRules: monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet
        },
        {
          label: 'ISEMPTY',
      ...
      const timeFunctionSuggestions = [
        ...
        },
        {
          ...
          kind: monaco.languages.CompletionItemKind.Function,
          insertText: 'PARALLELPERIOD(${1:level}[, ${2:numeric expression}[, ${3:member}]])',
          insertTextRules: monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet
        },
        {
          label: 'LASTPERIODS',
      ...
      const setsFunctionSuggestions = [
        ...
        },
        {
          label: 'ORDER',
          kind: monaco.languages.CompletionItemKind.Function,
          insertText: 'ORDER(${1:set}, ${2:value expression}[, ASC | DESC | BASC | BDESC])',
          insertTextRules: monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet
        },
        {
          label: 'TOPCOUNT',
        ...
        },
        {
          label: 'BOTTOMCOUNT',
          kind: monaco.languages.CompletionItemKind.Function,
          insertText: 'BOTTOMCOUNT(${1:set}, ${2:count}, ${3:value expression})',
          insertTextRules: monaco.languages.CompletionItemInsertTextRule.InsertAsSnippet
        },
        {
          label: 'DISTINCT',
