...
const removeFromAxis = (axis, hierarchyUniqueName) => {
  if (axis === "rows") {
    selectedRows.value = selectedRows.value.filter(
      (hierarchy) => hierarchy.HIERARCHY_UNIQUE_NAME !== hierarchyUniqueName,
    );
  } else {
    ...
    <va-collapse v-model="storeSelectionOpened" header="Request settings">
      <div class="settings-container">
        <va-divider class="pad_bottom" orientation="left">
          <span class="px-2">Select store</span>
        </va-divider>
        <div class="store_list">
          <div v-for="store in stores" :key="store.id" class="store_list-item">
            <va-radio
              :model-value="storeId"
            ...
            >
              <div>
                <div class="query_designer-area-header">
                  <div>Filters</div>
                  <VaButton icon="add" preset="secondary" round disabled />
                </div>
              ...
              <div>
                <div class="query_designer-area-header">
                  ...
                  <VaButton
                    ...
                    preset="secondary"
                    round
                    @click="openAxisSelectionModal('rows', store)"
                  />
                </div>
                <div class="query_designer-area">
                  ...
                  >
                    ...
                    <VaButton
                      ...
                      round
                      @click="
                        removeFromAxis('rows', item.HIERARCHY_UNIQUE_NAME)
                      "
                    />
                  </div>
                </div>
              ...
              <div>
                <div class="query_designer-area-header">
                  ...
                  <VaButton
                    ...
                    preset="secondary"
                    round
                    @click="openAxisSelectionModal('cols', store)"
                  />
                </div>
                <div class="query_designer-area">
                  <div
                  ...
                  >
                    ...
                    <VaButton
                      ...
                      round
                      @click="
                        removeFromAxis('cols', item.HIERARCHY_UNIQUE_NAME)
                      "
                    />
                  </div>
                </div>
