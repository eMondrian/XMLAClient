  ...
  <div class="queryDesigner">
    <div class="areas">
      ...
      <div class="queryDesignerArea">
        ...
        <div class="queryDesingnerArea_container">
          <draggable class="dragArea list-group" :list="queryConfig.rows" group="hierarchies" @change="changeItems('rows', $event)"
            item-key="id">
            <template #item="{ element }">
              <va-chip :model-value="true" :closeable="element.type !== 'Values'"
      ...
      <div class="queryDesignerArea">
        ...
        <div class="queryDesingnerArea_container">
          <draggable class="dragArea list-group" :list="queryConfig.measures" group="measures" @change="changeMeasures($event)"
            item-key="id">
            <template #item="{ element }">
